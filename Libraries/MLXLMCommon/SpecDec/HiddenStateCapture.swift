...
public protocol HiddenStateCaptureModel: LanguageModel {
    // Divergence from upstream monorepo: our DFlash v1 runtime
    // (SpecDecRuntimeLinear) validates drafter target_layer_ids against this
    // range. Upstream dropped the requirement; we keep it.
